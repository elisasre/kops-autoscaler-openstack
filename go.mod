...
replace (
	...
	k8s.io/kops => k8s.io/kops v1.27.1-0.20230805141431-4d12f73e6aee
...
require (
	...
	github.com/digitalocean/godo v1.100.0 // indirect
	...
	github.com/hetznercloud/hcloud-go v1.48.0 // indirect
